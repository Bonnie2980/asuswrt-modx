...
// HIWIFI4
#if defined(CONFIG_MODEL_RTHIWIFI4) || defined(CONFIG_MODEL_RTE8820S) || defined(CONFIG_MODEL_RTA040WQ) || defined(CONFIG_MODEL_RTMSG1500) || defined(CONFIG_MODEL_RTK2P) || defined(CONFIG_MODEL_RTWIA3300)
        offs = 0x140000;
#endif 
// HIWIFI4
...
// MIR3P
        ...
        if (rfs_offset != 0) {
            MSG(INIT, "[mtk_nand] Line = %d!\n", __LINE__);
// HIWIFI4
#if defined(CONFIG_MODEL_RTHIWIFI4) || defined(CONFIG_MODEL_RTE8820S) || defined(CONFIG_MODEL_RTA040WQ) || defined(CONFIG_MODEL_RTMSG1500) || defined(CONFIG_MODEL_RTK2P) || defined(CONFIG_MODEL_RTMIR3P) || defined(CONFIG_MODEL_RTMIR3G) || defined(CONFIG_MODEL_RTRM2100) || defined(CONFIG_MODEL_RTR2100) || defined(CONFIG_MODEL_RTWIA3300)
