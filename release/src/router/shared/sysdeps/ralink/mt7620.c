...
#define MT7621_GSW
#elif defined(RTN800HP) || defined(RTHIWIFI4) || defined(RTA040WQ) || defined(RTNEWIFI3) || defined(RTMSG1500) || defined(RTMT1300) || defined(RTRS1200P) || defined(RTK2P) || defined(RTWIA3300)
enum {
	WAN_PORT=4,
	LAN1_PORT=3,
	LAN2_PORT=2,
