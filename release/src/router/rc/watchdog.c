	...
	if (nvram_match("btn_ez_mode", "1"))
	{
		...
		if (BTN_pressed_count > WPS_LED_WAIT_COUNT && LED_status_changed == 0) {
			...
			if (LED_status_on) {
				TRACE_PT("LED turn to normal\n");
				led_control(LED_POWER, LED_ON);
#if defined(RTAC65U) || defined(RTAC85U) || defined(RTAC85P) || defined(RTN800HP) || defined(RTACRH26) || defined(RMAC2100) || defined(RTA040WQ) || defined(RTMSG1500) || defined(RTK2P) || defined(RTWIA3300)
